...
Основы работы с CRM в Bitrix24
• CRM в Bitrix24 делятся на простую и классическую.
• Простая CRM подходит для небольших компаний с небольшим потоком клиентов.
• Классическая CRM используется для работы с лидами и сделками, помогает в квалификации клиентов.
Выбор режима CRM
• В Bitrix24 можно выбрать режим работы CRM, влияющий на обработку заявок.
• Простая CRM рекомендуется для небольших отделов продаж, классическая - для средних и крупных.
Работа с лидами в Bitrix24
• В классической CRM заявки автоматически попадают в лиды, где происходит их обработка.
• Менеджеры могут быстро создавать и добавлять лиды через форму или через быстрый лид.
• Лиды можно перемещать по воронке продаж, определяя их статус и дальнейшие действия.
Работа с сделками в Bitrix24
• Сделка создается на основе сохраненного лида, где можно увидеть контактные данные клиента.
• На каждом этапе сделки есть уведомления, позволяющие отслеживать ее статус.
• Сделка завершается после оплаты клиентом и перевода его в раздел "Успешно".
